try{
	...
	var ifeffect = CmdLine.GetOption("ifeffect");
	...
	if(materialDef != undefined)
	{
		...
		mtldefworld = mtldefxml.root.GetChild("world");  //world
	...
	tworld = tworldxml.root.GetChild("library");//world
	load("convertimpoter.js");
	require("convertimpoter.js");
	
	//cullerpw = sectorw.CreateChild(tworldxml.NODE_ELEMENT);
