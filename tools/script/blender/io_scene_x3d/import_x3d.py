...
def importShape(node, ancestry, global_matrix):
    ...
    if geom:
        ...
        if appr:
            ...
            # print(mat, ima)
            matdefnode = mat.x3dNode.getAttributeNode('DEF')
            matdefname = "def_mat"
            if matdefnode is not None:
                #print(matdefnode.value)
                matdefname = matdefnode.value
            else:
                matusenode = mat.x3dNode.getAttributeNode('USE')
                if matusenode is not None:
                    matdefname = matusenode.value
            #print(matdefname)
            if mat or ima:
                ...
                if bpy.data.materials.find(matdefname) == -1:
                    bpymat = bpy.data.materials.new(matdefname)
                    ...
                    bpymat = bpy.data.materials[matdefname]
