...
##    "option_frame_step" : properties.option_frame_step,
    ...
    "option_zip" : properties.option_zip
    }
...
##    properties.option_frame_step = settings.get("option_frame_step", 1)
    ...
    properties.option_zip = settings.get("option_zip", False)
...
class ExportTHREEJS(bpy.types.Operator, ExportHelper):
    ...
    option_zip = BoolProperty(name = "Zip", description = "Zip json with textures", default = False)
    ...
    def execute(self, context):
        ...
        return io_mesh_threejs.export_threejs.export(self, context, **self.properties)
...
##        row.prop(self.properties, "option_url_base_html")
        ...
        row = layout.row()
        row.prop(self.properties, "option_zip")
