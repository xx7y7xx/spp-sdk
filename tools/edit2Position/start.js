...
try {
	...
	///TODO 需要专门写一个参数处理的函数，或者使用CS自带的参数接口。
	var Config = {};
	Config.ProjectRootPath = "/tools";
	Config.QuickPositionDataPath = Config.ProjectRootPath + "/ui/quick_position.xml";
	Config.QuickPositionBGImagePath = Config.ProjectRootPath + "/ui/data/kuaisudingwei_bg.jpg";
	...
	if(projPath !== null && projPath !== true)
	{
		...
		Config.QuickPositionDataPath = Config.ProjectRootPath + "/src/product/position/quick_position.xml";
		Config.QuickPositionBGImagePath = Config.ProjectRootPath + "/src/product/ui/kuaisudingwei_bg.jpg";
	}
